      ...
      <nav className="sticky top-0 z-50 border-b border-white/[0.06] bg-ink/90 backdrop-blur-sm px-6 py-4">
        <div className="flex items-center justify-between max-w-6xl mx-auto">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 md:w-8 md:h-8 border border-[#D4A853] flex items-center justify-center shrink-0">
              <span className="font-cinzel text-[#D4A853] text-[11px] md:text-[10px] font-bold tracking-wider">IB</span>
            </div>
