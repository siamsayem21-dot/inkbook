...
export default async function ProjectsPage({ params }: Props) {
  ...
  return (
    <div className="max-w-3xl">
      ...
      <h1 className="font-serif text-2xl md:text-3xl tracking-wide mb-3 text-zinc-900">Projects</h1>
      ...
      {projects.length === 0 ? (
        <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm px-6 py-16 text-center max-w-lg">
          <h2 className="font-serif text-xl md:text-2xl tracking-wide mb-3 text-zinc-900">No tattoo projects yet</h2>
