...
import ArtistMessageComposer from "./ArtistMessageComposer";

// Artist-only light/violet fork of components/messaging/ThreadView.tsx — see
// components/owner/OwnerThreadView.tsx for why this project forks the shared
// dark component instead of theming it in place. Same props/behavior
// (including the optimistic-append send pattern), visuals only.
...
export default function ArtistThreadView({ threadId, currentRole, initialMessages, labels, sendAction }: Props) {
