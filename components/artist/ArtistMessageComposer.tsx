...
// Artist-only light/violet fork of components/messaging/MessageComposer.tsx —
// see components/owner/OwnerMessageComposer.tsx for why this project forks
// the shared dark component instead of theming it in place. Same
// props/behavior, visuals only.
interface Props {
  text: string;
...
export default function ArtistMessageComposer({
  text,
  onTextChange,
  onSubmit,
  imagePreview,
