...
// Artist-only light/violet fork of components/messaging/ThreadList.tsx — see
// components/owner/OwnerThreadList.tsx for why this project forks rather than
// themes the shared dark component (Client Portal keeps using the original,
// untouched). Same props/behavior, visuals only.
...
export default function ArtistThreadList({ items, basePath, emptyTitle, emptyDescription }: Props) {
  if (items.length === 0) {
    return (
